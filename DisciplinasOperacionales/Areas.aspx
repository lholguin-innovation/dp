<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Areas.aspx.cs" Inherits="Areas" %>
...
<head runat="server">
    ...
    <title> Agregar &aacute;reas </title>
            ...
            <div class="app" id="app">
                ...
                <article class="content dashboard-page">
                    <div class="title-block">
                        <h2 class="title"> Agregar &aacute;reas </h2>
                    </div>
                    <section class="section">
                        <div class="row">
                            <div class="col-sm-3">
                                <label class="control-label" for="txtArea">&Aacute;rea</label>
...
<script class="init">
    function EliminarArea(area) {
        swal({
            title: "Cuidado!",
            text: "Estás a punto de eliminar esta área, deseas continuar?",
            type: "warning",
