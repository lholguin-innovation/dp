<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ContenidoDinamico.aspx.cs" Inherits="ContenidoDinamico" %>
...
<head runat="server">
    ...
    <title> Agregar contenido din&aacute;mico </title>
    ...
    <form id="form1" runat="server" method="post" enctype="multipart/form-data">
        <div class="main-wrapper">
            <div class="app" id="app">
                ...
                <article class="content dashboard-page">
                    <div class="title-block">
                        <h2 class="title"> Contenido din&aacute;mico para disciplinas (<%=lblPlanta.Text %>) </h2>
                    </div>
			...
			<div class="col-sm-3">
                            ...
                            <div class="col-sm-9">
                                <asp:Button ID="btnRealizar" CssClass="btn btn-primary" runat="server" Text="Cargar" OnClick="btnRealizar_Click"/>
                            </div>
                        </div>
                            <div class="col-sm-12">
                                <asp:Literal ID="litContDinamico" runat="server"></asp:Literal>
                            </div>			 
                        <div class="row">
                            <div class="col-sm-12">
                                <asp:Button ID="btnActualizar" CssClass="btn btn-success pull-right" runat="server" Text="Actualizar Contenido" OnClick="btnActualizar_Click" />
                            </div>
                        </div>
                    </section>
                </article>
...
<script class="init">
    $(document).ready(function () {
        ...
        table.buttons().container()
			.appendTo('#tablaContenido_wrapper .col-md-6:eq(0)');
    });
</script>
<script>
