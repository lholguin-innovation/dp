            ...
            <div class="app" id="app">
                ...
                <article class="content dashboard-page">
                    <div class="title-block">
                        <h2 class="title"> Historial de evaluaciones </h2>
                    </div>
                    <section class="section">
                        <div class="row">
                            <div class="col-sm-2">
                                <label class="control-label" for="ddlPlanta">Planta</label>
                                <asp:DropDownList ID="ddlPlanta" CssClass="form-control" runat="server"  OnSelectedIndexChanged="ddlPlanta_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                            </div>
                            <div class="col-sm-3">
                                <label class="control-label" for="ddlArea">&Aacute;rea</label>
                                <asp:DropDownList ID="ddlArea" CssClass="form-control" runat="server" OnSelectedIndexChanged="ddlArea_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                            </div>
                            <div class="col-sm-2">
                                <label class="control-label" for="txtMes">Mes</label>
                                <asp:TextBox ID="txtMes" CssClass="form-control" runat="server" TextMode="Month" OnTextChanged="txtMes_TextChanged" AutoPostBack="true"></asp:TextBox>
                            </div>
                            <div class="col-sm-2">
                                <label class="control-label" for="ddlSemana">Semana</label>
                                <asp:DropDownList ID="ddlSemana" CssClass="form-control" runat="server"></asp:DropDownList>
                            </div>
                            <div class="col-sm-1">
                                <asp:Button ID="btnBuscar" CssClass="btn btn-primary" runat="server" Text="Buscar" OnClick="btnBuscar_Click" />
                            </div>
                            <div class="col-sm-2">
                                <input type="button" class="btn btn-primary" id="btnImprimir" value="Imprimir" runat="server" visible="false" />
                            </div>
                        </div>
                        <br />
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <asp:Button ID="btnActualizar" CssClass="btn btn-success pull-right" Visible="false" runat="server" Text="Actualizar planes" OnClick="btnActualizar_Click" />
                            </div>
                        </div>
                    </section>
                </article>
...
<script class="init">
    $(document).ready(function () {
        ...
        table.buttons().container()
			.appendTo('#tablaAreas_wrapper .col-md-6:eq(0)');
        ...
        var table3 = $('#tablaPlanes').DataTable({
            searching: false,
            scrollY: "25vh",
            scrollX: true,
            info: false,
        ...
        table3.buttons().container()
			.appendTo('#tablaPlanes_wrapper .col-md-6:eq(0)');
    });

    function ImprimirDisciplinas(url) {
