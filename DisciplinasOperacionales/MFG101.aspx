<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MFG101.aspx.cs" Inherits="Reportes" %>
            ...
            <div class="app" id="app">
                ...
                <article class="content dashboard-page">
                    <div class="title-block">
                        <h2 class="title"> <%=tituloReportes %> </h2>
                    </div>
                    <section class="section">
                        <div class="row">
                            <div class="col-sm-2">
                                <label class="control-label" for="ddlPlanta">Planta</label>
                                <asp:DropDownList ID="ddlPlanta" CssClass="form-control" runat="server" ></asp:DropDownList>
                            </div>   
                            <div class="col-sm-2">
                                <label class="control-label" for="txtMes">Mes</label>
                                <asp:TextBox ID="txtMes" CssClass="form-control" runat="server" TextMode="Week"></asp:TextBox>
                            </div>
                            <div class="col-sm-2">
                                <label class="control-label" for="ddlTurno">Turno</label>
                                <asp:DropDownList ID="ddlTurno" CssClass="form-control" runat="server" ></asp:DropDownList>                                
                            </div>
                            <div class="col-sm-8">
...
<script class="init">
    $(document).ready(function () {
        var table = $('#tablaReportes').DataTable({
            ...
            lengthChange: false,
            buttons: [
                { extend: 'excelHtml5', title: '<%=tituloExcel%>' }
            ]
        });

        table.buttons().container()
			.appendTo('#tablaReportes_wrapper .col-md-6:eq(0)');
    });
</script>
</html>
